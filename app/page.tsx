...
export default function Home() {
  ...
  return (
	...
	<h1 className="text-center text-6xl font-bold pt-10 pb-20 text-white">About</h1>

	<div className="px-48 text-white flex flex-row flex-wrap">
	  <BackgroundGradient containerClassName="max-w-96 mx-10" className="rounded-[22px] p-4 sm:p-10 bg-violet-700 max-w-96">
	  ...
	  <BackgroundGradient containerClassName="max-w-96 mx-10" className="rounded-[22px] p-4 sm:p-10 bg-violet-700 max-w-96 text-justify">
      ...
      <div id="software-selection" className="w-screen h-full py-40 bg-violet-900">
	<h1 className="text-center text-6xl font-bold pt-10 pb-5 text-white">Our Software Selection</h1>
	<div className="h-dvh [perspective:1000px] relative b flex flex-col mx-40 my-0 max-w-[120rem] items-start justify-start py-3">
	  <Tabs tabs={tabs} />
	</div>
      </div>

      <div id="image-picker" className="w-screen h-screen bg-purple-800 px-48 text-white">
	<h1 className="text-center text-6xl font-bold py-10">Image Picker</h1>
		
	<p className="text-xl text-center pb-10">This page only exists because the distro isnt done yet, this will be just some screenshots and a way to choose them.</p>
